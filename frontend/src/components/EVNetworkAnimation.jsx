            ...
            <div className="container" style={{ textAlign: 'center', position: 'relative', zIndex: 10 }}>
                ...
                <div style={{
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem', alignItems: 'flex-end' }}>
                        <NodeCard icon={<Smartphone size={28} color="#60a5fa" />} title="User App" value="Locating..." color="#60a5fa" delay={0} align="right" />
                        <NodeCard icon={<Search size={28} color="#f472b6" />} title="Google Maps" value="Searching" color="#f472b6" delay={0.3} align="right" />
                    </div>
                    ...
                    <div style={{ position: 'relative', height: '400px', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                        ...
                        <motion.div
                            ...
                            animate={{ boxShadow: ['0 0 20px rgba(34, 197, 94, 0.2)', '0 0 60px rgba(34, 197, 94, 0.5)', '0 0 20px rgba(34, 197, 94, 0.2)'] }}
                        ...
                        >
                            <div style={{ display: 'flex', gap: '8px', alignItems: 'center', background: 'rgba(34, 197, 94, 0.1)', padding: '8px 16px', borderRadius: '20px', border: '1px solid rgba(34, 197, 94, 0.3)' }}>
                                ...
                                <span style={{ color: '#fff', fontSize: '0.9rem' }}>Route Optimized</span>
                            </div>
                        </motion.div>
                    </div>
...
const NodeCard = ({ icon, title, value, color, delay, align }) => (
    <motion.div
        ...
        style={{
            ...
            border: '1px solid rgba(255,255,255,0.05)', borderRadius: '16px', padding: '1.25rem',
            display: 'flex', alignItems: 'center', gap: '1rem', cursor: 'pointer',
            boxShadow: '0 4px 6px -1px rgba(0,0,0,0.1)', minWidth: '220px',
