        ...
        <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <div className="glass-card" style={{ padding: '3rem', width: '100%', maxWidth: '450px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <h2 style={{ fontSize: '2rem', fontWeight: 'bold' }}>Initialize Access</h2>
                    <p style={{ color: '#94a3b8' }}>Join the Smart Solar Network</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                    ...
                    <div>
                        ...
                        <div style={{ position: 'relative' }}>
                            <User size={20} style={{ position: 'absolute', left: '12px', top: '12px', color: '#64748b' }} />
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
                    ...
                    >
                        {isLoading ? 'Registering...' : (
                            <>
                                Grant Access <UserPlus size={18} style={{ marginLeft: '8px' }} />
                            </>
                        )}
                    </button>
                </form>
                ...
                <div style={{ textAlign: 'center', marginTop: '2rem', color: '#94a3b8' }}>
                    Already have a badge? <Link to="/login" style={{ color: '#0ea5e9', textDecoration: 'none' }}>Login Protocol</Link>
                </div>
